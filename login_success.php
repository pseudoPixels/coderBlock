...
<link href="CSS/menu_assets/bootstrap.css" rel="stylesheet" type="text/css">
...
<div class="my_right_content">
	...
	<h2 style="font-family:arial;color:#000000;">Submit Your Source Code Here</h2>
	<form name="compile" action="compiler.php?userName='145'" onsubmit="return confirm('Are you sure?');" method="post">
	<table>
	<tr>
 	<td width="20px;">Select Language : </td>
	<td width="30px;">
	<select name="lang">
	...
	<tr>
    <span style ="font-family:comic sans ms;font-size:9pt;color:#006600;"><td width="10%">Problem ID : </td></span><td width="10%">
    <?php
       if(isSet($_GET["problemID"])){
	   $id = $_GET["problemID"];
      
	   echo '<input type="text" name="id" placeholder="enter problem id" size="20" value="'.$id.'">';
      }
	  else {
	   echo '<input type="text" name="id" placeholder="enter problem id" size="20">';
	  }
	  echo "</td>";
    ?>	
	</table>
	 </br></br><span style="font-size:16px;">Paste Your Source Code Below :</span></br>
	<textarea style="font-family:sans serif; background-color:#F9F9F9;color:#000000; font-size:14px;" name="source" rows="20" cols="70" ></textarea>
	</br>
	
	<input class="mybutton2" type="submit" name="Submit"  value="Submit">
	</form>
