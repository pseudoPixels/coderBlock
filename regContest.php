...
<h2>Register Your Team</h2>
    <p><span style="color:#FF0000;font-size:10pt;">You must register your team before the competition starts to take part in the contest. ONLY TEAM LEADER CAN REGISTER A TEAM.</span></p>	
	
	<form name="regCon" action="regSpecefiedTeam.php?contestID=<?php echo $_GET['id']?>" method="post" onsubmit="return validateForm()"><br/><br/>
	 <span style=" font-size:15pt;color:#006600;">Team ID : </span><br/>
	   <input style="border:groove 3px #F9F9F9;font-family:sans serif; background-color:#F9F9F9;color:#000000; font-size:15px;" type="text" name="teamID" size="70">
	 <br/><br/>
	 <span style=" font-size:15pt;color:#006600;">Team Password : </span><br/>
     <input style="border:groove 3px #F9F9F9; font-family:sans serif; background-color:#F9F9F9;color:#000000; font-size:15px;" type="password" name="teamPassword" size="70">
	 
	 <br/><br/>
	 <input class="button-link" type="submit" name="regATeam" value="Register" >
</form>
</div>
