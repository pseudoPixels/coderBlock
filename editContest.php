...
<ul>
   ...
   <li class='active'><a href='editContest.php'><span>Edit Contest</span></a></li>
...
<div class="my_right_content">
	...
	<h2 style="font-family:arial;color:#000000">Select A Contest To Edit : </h2>
	   <select  id = "ProblemSelect" onchange = "loadTextDoc(this.value)" style="width:400px;">
	          <option>Select a contest to edit</option>
				<?php
					...
					while($row=mysql_fetch_array($result)){
					   //echo $row['contestName']."<br/>";
						$contestTime=strtotime($row['contestDate']);
						$time=time();
						if($time < $contestTime){
...
<br/><br/><br/><br/>
<div id ="editContestDiv"  style="color:black;width:700px;">
</div>
			...
			function loadTextDoc(str){
				...
				xmlhttp.onreadystatechange=function(){
					if (xmlhttp.readyState==4 && xmlhttp.status==200){
						document.getElementById("editContestDiv").innerHTML=xmlhttp.responseText;
						//document.getElementById("problemdescription").innerHTML=str;
						
						
					}
					else{
						document.getElementById("editContestDiv").innerHTML="Select A Problem";
					}
				}
				xmlhttp.open("GET","editContestGivenID.php?q="+str,true);
				xmlhttp.send();
			}
		</script>
