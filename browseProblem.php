...
<?php
   ...
   $sql = "SELECT * FROM probleminfo WHERE ProblemID='$id'";
   ...
   echo '<p style="color:#000000;font-family:sans serif; font-size:20px;">'; echo $row["probDesc"]; echo '</p>';
   
   echo '<br><br><h3 style="color:#0066CC;font-family:comic sans ms; font-size:30px;">The Input</h3>';
   echo '<p style="color:#000000;font-family:sans serif; font-size:20px;">'; echo $row["theInput"].'</p>';
   
   echo '<br><br><h3 style="color:#0066CC;font-family:comic sans ms; font-size:30px;">The Output</h3>';
   echo '<p style="color:#000000;font-family:sans serif; font-size:20px;">'; echo $row["theOutput"].'</p>';
   
   echo '<br><br><h3 style="color:#0066CC;font-family:comic sans ms; font-size:30px;">Sample Input</h3>';
   echo '<pre><span style="color:#000000;font-family:sans serif; font-size:20px;">'; echo $row["sampleInput"].'</span></pre>';
   
   
   echo '<br><br><h3 style="color:#0066CC;font-family:comic sans ms; font-size:30px;">Sample Output</h3>';
   echo '<pre><span style="color:#000000;font-family:sans serif; font-size:20px;">'; echo $row["sampleOutput"].'</span></pre>';
?>
