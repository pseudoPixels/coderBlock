...
<h2 style="font-family:arial;color:#000000">Success !!! </h2>
...
include("Config.php");
    ...
    $userName = $_POST['usernameProblemSetter'];
	$password = $_POST['passwordProblemSetter'];
	

	
	//INSERTING INTO THE userInfo TABLE
	$sql = "INSERT INTO problemsetter(userName, password, fullName, details, startingDate) VALUES('$userName', '$password', '$fullName','$details', now())";
	mysql_query($sql);
	

	echo "<br/><br/><br/><span style='font-size:25px;color:green'><strong>A New Problem Setter has been added Successfully.</strong></span>" ;
	echo "";
	echo "";
?>
